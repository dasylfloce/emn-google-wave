...
@Gadget.ModulePrefs(title = "Doodle-like Gadget", title_url = "about.html", description = "A simple doodle like gadget, built using GWT.", author = "Florent DAVID, Matthieu SALLFRANQUE, Jean-François VERDONCK", author_email = "dasylfloce+doodle@gmail.com", height = 600)
/**
...
public class Gadget extends WaveGadget<UserPreferences> {
	...
	public Gadget() {
		...
		// Button simpleButton = new Button("Créer un évènement", new
		// ClickHandler() {
		...
		Button openButton = new Button("Ajouter une date", new ClickHandler() {
